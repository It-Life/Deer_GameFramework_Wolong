...
/*--------------------Auto generate start button listener.Do not modify!--------------------*/
        ...
        protected override void OnOpen(object userData)
        {
            ...
            Debug.Log($"tackor 获得的星星 {starNum}");
        ...
        LoopListViewItem2 OnGetItemByIndex(LoopListView2 listView, int index)
        {
            ...
            string collectionPath = AssetUtility.UI.GetSpriteCollectionPath("SelectRace");
            itemScript.mBgImg.SetSprite(collectionPath, AssetUtility.UI.GetSpritePath($"SelectRace/{itemData.bg}"));
		...
		private void Btn_PlayEvent(){
            ProcedureMenu procedure = (ProcedureMenu)GameEntry.Procedure.CurrentProcedure;

...
/*--------------------Auto generate end button listener.Do not modify!----------------------*/
		...
		protected override void OnOpen(object userData)
		{
			...
			//显示星星
			string collectionPath = AssetUtility.UI.GetSpriteCollectionPath("Others");
			if (curLevelStar > 0)
				m_Img_Star1.SetSprite(collectionPath, AssetUtility.UI.GetSpritePath($"Others/Icon_star1_light"));
			else
				m_Img_Star1.SetSprite(collectionPath, AssetUtility.UI.GetSpritePath($"Others/Icon_star1_gray"));

			if (curLevelStar > 1)
				m_Img_Star2.SetSprite(collectionPath, AssetUtility.UI.GetSpritePath($"Others/Icon_star1_light"));
			else
				m_Img_Star2.SetSprite(collectionPath, AssetUtility.UI.GetSpritePath($"Others/Icon_star1_gray"));

			if (curLevelStar > 2)
				m_Img_Star3.SetSprite(collectionPath, AssetUtility.UI.GetSpritePath($"Others/Icon_star1_light"));
			else
				m_Img_Star3.SetSprite(collectionPath, AssetUtility.UI.GetSpritePath($"Others/Icon_star1_gray"));

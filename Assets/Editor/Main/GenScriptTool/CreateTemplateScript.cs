...
{
    //脚本模板路径
    private const string TemplateScriptPath = "Assets/Editor/Main/GenScriptTool/Template/MyTemplateScript.cs.txt";
    private const string TemplateProcedureScriptPath = "Assets/Editor/Main/GenScriptTool/Template/MyTemplateProcedureScript.cs.txt";

...
namespace HybridCLR.Editor.BuildProcessors
{
    ...
    internal class BPFilterHotFixAssemblies : IFilterBuildAssemblies
    {
        ...
        {
            List<string> allHotUpdateDllNames = HybridCLRConfig_Custom.HotUpdateAssemblies;
            ...
            // 将热更dll从打包列表中移除
            return assemblies.Where(ass => HybridCLRConfig_Custom.HotUpdateAssemblies.All(dll => !ass.EndsWith(dll, StringComparison.OrdinalIgnoreCase))).ToArray();
        }
    }
}

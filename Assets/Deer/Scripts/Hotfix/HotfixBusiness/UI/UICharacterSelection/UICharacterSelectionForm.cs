...
/*--------------------Auto generate end button listener.Do not modify!----------------------*/
        ...
        protected override void OnResume()
        {
			...
			if (GameEntry.Procedure.CurrentProcedure.GetType().Equals(typeof(ProcedureMenu)) && Visible)
			{
		...
		void ShowSelectedCharacter()
		{
			...
			if (dataList.Count > 0)
			{
				...
				UIEntityCharacterData tmpData = new UIEntityCharacterData(GameEntry.Entity.GenEntityId(), 1, dataList[curSelectedCharacterIndex].Name);
		...
		private void Btn_NextEvent()
		{
			...
			//打开 赛道选择页面
			//如何传递参数 index
			GameEntry.UI.OpenUIForm(UIFormId.UIRaceSelectionForm, this);
		}

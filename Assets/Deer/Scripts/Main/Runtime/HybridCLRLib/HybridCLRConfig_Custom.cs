...
/// </summary>
public static class HybridCLRConfig_Custom
{
    /// <summary>
    ...
    /// </summary>
    private static readonly List<string> MonoHotUpdateAssembliesNames = new List<string>()
        {
            "HotfixFramework.Runtime.dll",
            "HotfixBusiness.dll",
        };
    private static readonly List<string> HotUpdateAssembliesNames = new List<string>()
        {
    ...
    /// 所有热更新dll列表
    /// </summary>
    public static readonly List<string> HotUpdateAssemblies = HotUpdateAssembliesNames.Concat(MonoHotUpdateAssembliesNames).ToList();

    public static readonly List<string> AOTMetaAssemblies = new List<string>()
        {
            "mscorlib.dll",
            "System.dll",

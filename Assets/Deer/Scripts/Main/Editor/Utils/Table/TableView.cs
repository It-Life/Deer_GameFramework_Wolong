...
namespace Game.Main.Editor
{
    ...
    public class TableView<T> : TreeView where T : class, new()
    {
        ...
        /// 当前选择的表格数据
        /// </summary>
        protected List<T> _selectionDatas;
        /// <summary>
        /// 根元素
        /// </summary>
        protected TableViewItem<T> _rootItem;
        /// <summary>
        /// 所有的元素
        /// </summary>
        protected List<TableViewItem<T>> _items;
        /// <summary>
        /// 所有的元素绘制项
        /// </summary>
        protected List<TreeViewItem> _drawItems;
        /// <summary>
        /// 搜索控件
        /// </summary>
        protected SearchField _searchField;
        /// <summary>
        /// 元素ID标记
        /// </summary>
        protected int _idSign = 0;
        ...
        public TableView(List<T> datas, List<TableColumn<T>> columns) : base(new TreeViewState())
        {
            ...
            SetTableViewData(datas, columns);
        }

        public void SetTableViewData(List<T> datas, List<TableColumn<T>> columns)
        {
        ...
        protected override void ContextClicked()
        {
            ...
            {
                if (OnRightAddRow == null) AddData(new T());
                else OnRightAddRow.Invoke();
            });
        ...
        /// 获取索引列
        /// </summary>
        protected virtual TableColumn<T> GetIndexColumn()
        {
        ...
        /// 当重新排序
        /// </summary>
        protected virtual void OnSortingChanged(MultiColumnHeader columnheader)
        {
        ...
        /// 当列激活状态改变
        /// </summary>
        protected virtual void OnVisibleColumnsChanged(MultiColumnHeader columnheader)
        {
            Reload();
        }
        ...
        /// </summary>
        /// <param name="datas">数据</param>
        public virtual void DeleteDatas(List<T> datas)
        {
            for (int i = 0; i < datas.Count; i++)
            {
                T data = datas[i];
        ...
        /// </summary>
        /// <param name="data">数据</param>
        public virtual void SelectData(T data)
        {
            if (!_datas.Contains(data))
                return;
        ...
        public virtual void SelectData(T data, TreeViewSelectionOptions options)
        {
            if (!_datas.Contains(data))
                return;
        ...
        /// </summary>
        /// <param name="datas">数据</param>
        public virtual void SelectDatas(List<T> datas)
        {
        ...
        /// <param name="datas">数据</param>
        /// <param name="options">选中的操作</param>
        public virtual void SelectDatas(List<T> datas, TreeViewSelectionOptions options)
        {
            List<int> ids = new List<int>();
            for (int i = 0; i < datas.Count; i++)
            {

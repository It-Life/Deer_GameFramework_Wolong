...
public static class HotfixDefine
{
    ...
    /// </summary>
    public static readonly List<string> HotFixBusinessDllNames = new List<string>()
        {
            "HotfixBusiness.dll",
        };
    ...
    /// 所有热更新dll列表
    /// </summary>
    public static readonly List<string> AllHotFixDllNames = HotFixBusinessDllNames.Concat(new List<string>
        {
